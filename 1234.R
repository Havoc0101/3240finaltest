...
/* Final floating explanation card position */
.final-float {
  left: 42px !important;
  top: 210px !important;
  z-index: 1000000 !important;
...
.final-page-card {
  min-height: 1500px;
  padding: 44px 46px 80px 46px !important;
  overflow: visible;
}
...
/* Each scroll section: one image + one text block */
.scroll-polaroid-section {
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 58px;
  ...
  animation: slideUpPolaroid 0.95s ease forwards;
}

/* Second section appears slightly later */
.scroll-polaroid-section:nth-of-type(2) {
  animation-delay: 0.2s;
}

/* Third section appears slightly later */
.scroll-polaroid-section:nth-of-type(3) {
  animation-delay: 0.4s;
}

/* Reverse layout for the middle image */
.reverse-section {
  flex-direction: row-reverse;
}

/* White Polaroid frame only contains the image */
.polaroid-frame {
  width: 420px;
  background: #ffffff;
...
/* Hover effect keeps Polaroid feeling */
.polaroid-frame:hover {
  transform: translateY(-8px) scale(1.035) rotate(0deg);
  box-shadow: 0 28px 58px rgba(37, 99, 235, 0.24);
}

/* Text block beside / below image */
.polaroid-text-block {
  max-width: 460px;
  text-align: left;
}

/* Large title outside the photo */
.polaroid-text-block h3 {
  color: #1d4ed8;
  font-weight: 900;
  font-size: 34px;
  line-height: 1.2;
...
/* Larger description outside the photo */
.polaroid-text-block p {
  font-size: 20px;
  line-height: 1.75;
  color: #334155;
  margin-bottom: 16px;
...
/* Scroll-like slide-up animation */
@keyframes slideUpPolaroid {
  from {
    opacity: 0;
